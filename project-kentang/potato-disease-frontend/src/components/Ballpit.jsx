...
const F = new a(), I = new a(), O = new a(), V = new a();
const B = new a(), N = new a(), _ = new a(), j = new a();
const H = new a(), T = new a();
    ...
    for (let idx = r; idx < t.count; idx++) {
      ...
      for (let jdx = idx + 1; jdx < t.count; jdx++) {
        ...
        if (dist < sumRadius) {
          ...
          O.add(j); N.add(T);
          O.toArray(s, otherBase); N.toArray(o, otherBase);
        }
      }
      if (t.controlSphere0) {
        _.copy(F).sub(I);
    ...
    if (Array.isArray(e) && e.length > 1) {
      const t = (function (e) {
        ...
        function setColors(e) {
          t = e;
          i = [];
          t.forEach(col => { i.push(new l(col)); });
        }
        setColors(e);
        return {
          setColors,
