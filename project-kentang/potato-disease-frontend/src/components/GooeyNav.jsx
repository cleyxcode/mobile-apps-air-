...
const GooeyNav = ({
  ...
  // Sync when route changes externally (e.g. browser back/forward)
  useEffect(() => {
  ...
  const handleClick = (e, index) => {
    ...
    if (activeIndex === index) {
      // still navigate even if already active
      items[index]?.onClick?.();
      return;
    }
  ...
  return (
    <>
      <style>{`
        ...
        .gooey-nav li.active { color: #0c100e; text-shadow: none; }
